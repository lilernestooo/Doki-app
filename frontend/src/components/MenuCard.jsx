...
.menu-card {
  ...
  /* ✅ FIXED WIDTH BALANCE */
  width: 100%;
  max-width: 420px;   /* better visual balance */
  min-width: 320px;   /* prevents too small shrink */
...
.menu-card__btn:hover .menu-card__arrow {
  ...
  return (
    <>
      ...
      <div className="menu-splash">
        <div className="menu-splash__eyebrow">
        ...
        <div className="menu-card" onClick={onEnter}>
          ...
          <div className="menu-card__art">
            <img src={baristaImg} alt="Barista preparing coffee" />
          </div>
